      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-slate-600 dark:text-slate-300">
            Quick intro, favorite tools, and the tech I work with.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <ul className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <li
                  key={i}
                  className="group relative rounded-2xl p-5 bg-slate-50/70 dark:bg-white/5
                             ring-1 ring-slate-200 dark:ring-white/10
                             hover:ring-slate-300 hover:dark:ring-white/20 transition"
                >
                  <Image src={icon as StaticImageData} alt={title} className="w-7 h-7 mb-3 opacity-80 group-hover:opacity-100" />
                ...
                {tools.map((tool) => (
                  <li key={tool.name} className="relative group">
                    <a
                      ...
                      className="w-12 h-12 rounded-xl border border-slate-200 dark:border-white/10
                                 bg-white dark:bg-white/10 flex items-center justify-center
