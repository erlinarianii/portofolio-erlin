...
const About: React.FC = () => {
  return (
    <div id="about" className="w-full px-[12%] py-20 bg-white text-gray-800">
      <h4 className="text-center text-lg mb-2 font-Outfit text-gray-600">Introduction</h4>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1">
          <p className="mb-10 text-gray-700 font-Outfit leading-relaxed">
          ...
          <ul className="grid sm:grid-cols-3 gap-6 mb-10">
            {infoList.map(({ icon, title, description }, i) => (
              <li key={i} className="p-6 bg-gray-50 border border-gray-300 rounded-xl hover:-translate-y-1 duration-300 shadow-sm">
